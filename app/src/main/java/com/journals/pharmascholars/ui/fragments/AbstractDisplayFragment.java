...
import com.journals.pharmascholars.databinding.FragmentAbstractDisplayBinding;
import com.journals.pharmascholars.helper.utils;
import com.journals.pharmascholars.ui.viewmodel.AbstactDisplayViewModel;
        ...
        abstactDisplayViewModel.getAbstractDisplayRepository().observe(getViewLifecycleOwner(), homeResponse -> {
           // List<JournalHomeResponse> catDetailsBeanList = homeResponse.getAbt_journal_details();
            ...
            if (homeResponse.isStatus()){
                if (homeResponse.getAbstract_details().get(0).getAbstractX() != null){
